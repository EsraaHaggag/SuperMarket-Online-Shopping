...
int main() {
	...
	clients[2] = { "salma","123456",3,"cairo","01212457859" };
	...
	char ans, add, anotherfunction, forget;
	...
	do {
		...
		if (choice == '1') {
			...
			cout << "Do you want to do Another operation, Press(Y) or (y) for yes, any other key if you don't want to and want to logout" << endl;
			cin >> anotherfunction;
			...
			Review(order1.products_list, numberofproducts);
			order1.totalprice = totalprice(order1.products_list, numberofproducts);
			cout << "Total Price:" << "  " << order1.totalprice << " " << "EGP" << endl << endl << endl;
			cout << "Do you want to do Another operation, Press(Y) or (y) for yes, any other key if you don't want to and want to logout" << endl;
			cin >> anotherfunction;
			switch (anotherfunction) {
			case'Y':
...
void select(product food[5], product juices[5], product cleaning_products[5], product products_list[], int& numberofproducts, int category, int product_no) {
	cout << "If You Want TO buy this product Press(Y) or (y) for yes, any other key if you don't want to" << endl;
	char answer;
	cin >> answer;
